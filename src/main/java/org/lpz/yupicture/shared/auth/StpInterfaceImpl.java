...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceUserId != null) {
            ...
            SpaceUser one = spaceUserApplicationService.lambdaQuery().eq(SpaceUser::getSpaceId, spaceUser.getSpaceId())
        ...
        if (spaceId == null) {
            ...
            if (spaceId == null) {
                // 仅本人和管理员可操作，否则仅可查看
                if (!user.getId().equals(picture.getUserId()) && !user.isAdmin()) {
        ...
        if (spaceType.equals(SpaceTypeEnum.PRIVATE.getValue())) {
            ...
            SpaceUser teamSpaceUser = spaceUserApplicationService.lambdaQuery().eq(SpaceUser::getSpaceId, spaceId)
                    .eq(SpaceUser::getUserId, userId)
