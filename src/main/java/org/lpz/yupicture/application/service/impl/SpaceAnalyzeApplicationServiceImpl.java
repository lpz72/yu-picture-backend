...
import org.lpz.yupicture.domain.space.service.SpaceAnalyzeDomainService;
...
@Service
@Slf4j
public class SpaceAnalyzeApplicationServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    private void checkSpaceAnalyzeAuth(SpaceAnalyzeRequest spaceAnalyzeRequest, User loginUser) {
        ...
        if (queryAll || queryPublic) {
            ...
            // 仅管理员和创建者可以查询指定空间
            ThrowUtils.throwIf(!loginUser.isAdmin() && !space.getUserId().equals(loginUser.getId()), ErrorCode.NO_AUTH_ERROR);
